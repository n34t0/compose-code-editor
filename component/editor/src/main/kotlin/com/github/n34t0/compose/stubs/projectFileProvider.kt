...
val projectList: List<ProjectDescription> = listOf(
    ...
    ProjectDescription(
        ...
        """.trimIndent(),
        diagnostics = listOf(
            DiagnosticStub(6, 8, 6, 12, "Condition is always 'true' ", SeverityStub.INFO),
            DiagnosticStub(4, 4, 4, 6, "Unresolved reference: vl", SeverityStub.ERROR),
            DiagnosticStub(4, 12, 4, 13, "Expecting an element", SeverityStub.WARNING),
            DiagnosticStub(4, 23, 4, 24, "Expecting an element", SeverityStub.WARNING),
            DiagnosticStub(4, 30, 4, 31, "Expecting an element", SeverityStub.WARNING),
            DiagnosticStub(5, 4, 5, 8, "Unresolved reference: list", SeverityStub.ERROR),
            DiagnosticStub(7, 16, 7, 20, "Unresolved reference: list", SeverityStub.ERROR),
            DiagnosticStub(15, 4, 15, 10, "Unreachable code", SeverityStub.WARNING),
            DiagnosticStub(11, 16, 11, 19, "Variable 'str' is never used", SeverityStub.INFO),
            DiagnosticStub(10, 8, 12, 9, "The lambda expression is unused. If you mean a block, you can use 'run { ... }'",
                SeverityStub.WARNING)
        )
    ),
...
class ProjectDescription(
    ...
    val code: String = "",
    val diagnostics: List<DiagnosticStub> = emptyList()
) {
