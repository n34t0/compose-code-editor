...
import com.github.n34t0.compose.fork.AtomicLong

class SelectionRegistrarImpl : SelectionRegistrar {
    /**
     ...
     */
    val selectableMap: Map<Long, Selectable>
        get() = _selectableMap
     ...
     */
    var onPositionChangeCallback: ((Long) -> Unit)? = null

    /**
     * The callback to be invoked when the selection is initiated.
     */
    var onSelectionUpdateStartCallback: (
     ...
     */
    var onSelectionUpdateSelectAll: (
        (Long) -> Unit
    )? = null
