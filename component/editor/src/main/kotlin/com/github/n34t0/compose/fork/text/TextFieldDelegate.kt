...
// visible for testing
const val DefaultWidthCharCount = 10 // min width for TextField is 10 chars long
val EmptyTextReplacement = "H".repeat(DefaultWidthCharCount) // just a reference character.
