...
import com.github.n34t0.compose.fork.fastFold
 ...
 */
class SelectionManager(private val selectionRegistrar: SelectionRegistrarImpl) {
    /**
     ...
     */
    fun requireContainerCoordinates(): LayoutCoordinates {
